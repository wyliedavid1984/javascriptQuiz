...
//     var answer = questionBank[i].answerBank[j];
...
document.getElementById("clearHighScores").addEventListener("click", function(){
    ...
    var messageDiv = document.getElementById("clearHighScoreMessage");
    var messageClear = document.createElement("p");
    messageClear.textContent = "The Scores will be clear out next round good Luck!!"

    messageDiv.appendChild(messageClear);
